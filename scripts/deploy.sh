...
cd /home/ec2-user/tech_eazy_devops_sohampatil44
...
# Copy config
CONFIG_FILE="/home/ec2-user/tech_eazy_devops_sohampatil44/configs/${stage}.json"
DEST="/home/ec2-user/tech_eazy_devops_sohampatil44/configs/config.json"
...
sudo cp /home/ec2-user/tech_eazy_devops_sohampatil44/configs/cloudwatch-agent-config.json /opt/aws/amazon-cloudwatch-agent/etc/amazon-cloudwatch-agent.json
